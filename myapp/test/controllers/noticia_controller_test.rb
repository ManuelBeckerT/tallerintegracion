...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { comentario: @noticium.comentario, contenido: @noticium.contenido, id: @noticium.id, id_user: @noticium.id_user, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { comentario: @noticium.comentario, contenido: @noticium.contenido, id: @noticium.id, id_user: @noticium.id_user, titulo: @noticium.titulo } }
